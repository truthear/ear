 ...
 */
int aes_setkey_enc(AESCONTEXT *ctx, const unsigned char *key, unsigned int keysize)
{
    unsigned int i;
    uint32_t *RK;
 ...
 */
int aes_setkey_dec(AESCONTEXT *ctx, const unsigned char *key, unsigned int keysize)
{
    int i, j;
    AESCONTEXT cty;
    uint32_t *RK;
